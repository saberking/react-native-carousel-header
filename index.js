...
const animateTo = (parameterToAnimate, value, duration, callback) => {
...
const clamp = (value, bottom, top) => Math.max(bottom, Math.min(top, value))
...
class Carousel extends React.Component {
  ...
  getLocationAfterMove(dx) {
    return clamp(this.leftOffsetAtPanStart + dx, this.getMinOffset(), this.getMaxOffset())
  }
